...
public class APIClient
{
	...
	public JSONObject addResultForTestCase(String testRunId, String testCaseId, Object data) {
		JSONObject response;
		try {
			response = (JSONObject) sendPost("add_result_for_case/" + testRunId + "/" + testCaseId, data);
		} catch (IOException e) {
	...
	public JSONObject addAttachmentToResult(String resultId, String attachmentPath) {
		JSONObject response;
		try {
			response = (JSONObject) sendPost("add_attachment_to_result/" + resultId,  attachmentPath );
		} catch (IOException e) {
			throw new RuntimeException(e);
		} catch (APIException e) {
			throw new RuntimeException(e);
