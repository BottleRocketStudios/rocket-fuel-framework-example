...
import example.config.AndroidAutomationComponents;
import example.config.DeviceAutomationComponents;
import example.config.IosAutomationComponents;
import example.config.WebAutomationComponents;
