    ...
    public void generalAssertion(AssertionPayload payload) {
        ...
        if (payload.assertSuccessful) {
            ...
            if (payload.takeScreenshotSuccess) {
                String screenshotName = !payload.screenShotSuccessFilename.isEmpty() ? payload.screenShotSuccessFilename : "assertion_success_" + System.currentTimeMillis();
            ...
            if (payload.takeScreenshotFailure) {
                String screenshotName = !payload.screenShotFailFilename.isEmpty() ? payload.screenShotFailFilename : "assertion_failed_" + System.currentTimeMillis();
                testManager.userOp.takeScreenshot(screenshotName);
            }
        }
    }
